...
public class StartNoGui {
	...
	public static void main(String[] args) {
		...
		Parameters.maxGene = +2;
		Parameters.minGene = -2; // specifies minimum and maximum weight values

		// Parameters for mutation 
		// Rate = probability of changing a gene
		// Change = the maximum +/- adjustment to the gene value
		Parameters.mutateRate = 0.01; // mutation rate for mutation operator
		Parameters.mutateChange = 0.05; // delta change for mutation operator
		Parameters.seed = 1523892140798L;
